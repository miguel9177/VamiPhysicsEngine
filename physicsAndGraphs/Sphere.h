...
public:
	...
	Sphere(const char* TextureLocationName_, glm::vec3 position_,float radius_, glm::vec3 rotation_, float mass_, bool movable_, float coeficientOfRestitution_, float friction_);
